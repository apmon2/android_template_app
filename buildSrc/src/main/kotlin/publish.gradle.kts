    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/apmon2/androidtemplateapp/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/apmon2/androidtemplateapp.git")
                    developerConnection.set("scm:git:ssh://github.com/apmon2/androidtemplateapp.git")
                    url.set("https://github.com/apmon2/androidtemplateapp/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/apmon2/androidtemplateapp/issues")
                }
            }
        }
    }
